...
- ```SELECT TO_TIMESTAMP(start_timestamp/1000), TO_TIMESTAMP(end_timestamp/1000), * FROM ia_schema.tbl_checklist_schedule WHERE checklist_id_fk = 699 ORDER BY checklist_schedule_id DESC;``` checklist schedule details against checklist id
